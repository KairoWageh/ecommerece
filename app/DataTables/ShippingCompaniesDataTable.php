...
class ShippingCompaniesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.shippingCompanies.btn.checkbox')
            ->addColumn('edit', 'admin.shippingCompanies.btn.edit')
            ->addColumn('delete', 'admin.shippingCompanies.btn.delete')
     ...
     *
     * @param \App\ShippingCompaniesDataTable $model

...
return [
    ...
    "delete_all"                       => "حذف الكل",
    "delete"                           => "حذف",
    "please_check_some_records"        => "من فضلك اختر بعض السجلات لحذفها",
    "ask_delete_item"                  => "هل أنت متأكد من أنك تريد حذف هذه السجلات؟عددهم هو " ,
    "yes"                              => "نعم",
    "no"                               => "لا",
    "close"                            => "إغلاق",
    ...
    "sitename_en"                      => "إسم الموقع بالإنجليزية",
    "logo"                             => "شعار الموقع",
    "icon"                             => "الرمز",

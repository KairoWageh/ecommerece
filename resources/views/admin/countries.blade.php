                    ...
                    countries_table.find('tr').each(function(){
                        if($(this).attr('id') == country_id){
                            $(this).find('td').each (function(index, tr) {
                                if(index == 1){
                                    $(this).html(response.country.country_name_ar);
                                }
                                if(index == 2){
                                    $(this).html(response.country.country_name_en);
                                }
                                if(index == 3){
                                    $(this).html(response.country.country_code);
                                }
                                if(index == 4){
                                    $(this).html(response.country.country_iso_code);
                                }
                            });
                        }
                    });

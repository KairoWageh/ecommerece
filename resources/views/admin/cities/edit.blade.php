        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => ['cities.update', $city->id], 'method' => 'put']) !!}
                <div class="form-group">
                    ...
                    {!! Form::text('city_name_ar', old('city_name_ar', $city->city_name_ar), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('city_name_en', __('admin.name_en')) !!}
                    {!! Form::text('city_name_en', old('city_name_en', $city->city_name_en), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">

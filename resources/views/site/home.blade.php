...
{{--                        <h4 class="caption subtitle">Dual SIM</h4>--}}
                        <a class="caption button-radius" href="#"><span class="icon"></span>{{__('shop_now')}}</a>
                    </div>
                </li>
            @endforeach
		</ul>
						...
						<div class="single-product">
							<div class="product-f-image"  width="195px" height="243px">
								...
								{{__('add_to_cart')}}
									...
									<a href="{{route('user.single_product', $product->id)}}" class="view-details-link"><i class="fa fa-link"></i> {{__('see_datails')}}</a>
								</div>
							</div>
